    ...
    a: (
      <ol>
        <li>
          ...
          same build. Downloading the same season and build guarantees this. To
          confirm it in game, enable <strong>Show Metrics</strong> in the game
          settings to see the build number
        </li>
        <li>
  ...
  return (
    <>
      ...
      <Callout label="// NOTE">
        ...
        not, start with the <Link href="/getting-started">Getting Started</Link>{" "}
        guide.
      </Callout>
      ...
      <Prose>
        <ol>
          ...
          <OnLinux>
            <li>
              Download the latest Radmin VPN{" "}
          ...
          <li>
            Create a network in Radmin VPN or join one that your friends are
            already in
          </li>
        </ol>
      </Prose>
