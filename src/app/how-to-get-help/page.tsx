  ...
  return (
    <>
      ...
      <Callout label="// NOTE">
        ...
        . To get a fast and useful response, follow this structure when
        reporting.
      </Callout>
      ...
      <Prose>
        ...
        <p>
          ...
          your machine. Do <strong>NOT</strong> take photos of your screen with
          a phone.
        </p>
      ...
      <Prose>
        <h3>Bad Example</h3>
        <ContentImage
          src="/media/others/bad-example.webp"
        ...
        <h3>Good Example</h3>
        <ContentImage
          src="/media/others/good-example.webp"
